                ...
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="<?= site_url('User/editPost') ?>" method="post">
                                    <!-- Form Group (Nama)-->
                                    ...
                                    <!-- Save changes button -->
                                    <!-- <button class="btn btn-primary" formaction="<?= site_url('User/editPost') ?>" formmethod="post" type="button">Simpan</button> -->
